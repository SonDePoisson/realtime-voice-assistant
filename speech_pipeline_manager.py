...
class SpeechPipelineManager:
    ...
    def __init__(
        ...
        Args:
            tts_engine: The TTS engine to use (e.g., "edgeTTS").
        ...
        while not self.shutdown_event.is_set():
            try:
                ...
                if request.action == "prepare":
                    ...
                    logger.info("🗣️🤷 Request Processor: Received 'finish' action (currently no-op).")
    ...
    def _llm_inference_worker(self):
        ...
        while not self.shutdown_event.is_set():
            ...
            try:
                ...
                logger.info(
                    f"🗣️🧠🏁 [Gen {gen_id}] LLM Worker: Generator loop finished%s"
